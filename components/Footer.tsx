...
export default function Footer() {
  return (
    <footer className="border-t border-[#3D7EFF]/10 mt-24">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          {/* Brand */}
          <div>
            <span className="text-[1.1rem] text-[#EDE8E0]" style={{ fontFamily: "var(--font-dm-serif), Georgia, serif", fontWeight: 400 }}>Vision Aquatics</span>
          ...
          {/* Links */}
          <nav className="flex flex-wrap gap-6 text-sm text-[#7FA8BF] tracking-[0.01em]">
        ...
        <div className="mt-10 pt-6 border-t border-[#3D7EFF]/10 text-center text-xs text-[#7FA8BF]">
